                ...
                <section className={styles.formSection}>
                  ...
                  <div className={styles.formRow}>
                    <div className={styles.formGroup}>
                      ...
                      <input type="text" id="sustainability" value={sustainability} onChange={(e) => setSustainability(e.target.value)} className={styles.input} placeholder="Sustainable practices..." disabled={isSaving} />
                    </div>
                    <div className={styles.formGroup}>
                      <label htmlFor="certification">Certification</label>
                      <input type="text" id="certification" value={certification} onChange={(e) => setCertification(e.target.value)} className={styles.input} placeholder="Wine certifications..." disabled={isSaving} />
                    </div>
                  </div>
                  <div className={styles.formRow}>
                    <div className={styles.formGroup}>
                      <div className={styles.checkboxGroup}>
                        <input type="checkbox" id="vegan" checked={vegan} onChange={(e) => setVegan(e.target.checked)} className={styles.checkbox} disabled={isSaving} />
                        <label htmlFor="vegan" className={styles.checkboxLabel}>Vegan-friendly</label>
                      </div>
                    </div>
                    <div className={styles.formGroup}>
                      <div className={styles.checkboxGroup}>
                        <input type="checkbox" id="allergens" checked={allergens} onChange={(e) => setAllergens(e.target.checked)} className={styles.checkbox} disabled={isSaving} />
                        <label htmlFor="allergens" className={styles.checkboxLabel}>Contains allergens</label>
                      </div>
                    </div>
                  </div>
                </section>
                ...
                <section className={styles.formSection}>
                  ...
                  <div className={styles.formRow}>
                    <div className={styles.formGroup}>
                      ...
                      <input type="text" id="climate" value={climate} onChange={(e) => setClimate(e.target.value)} className={styles.input} placeholder="Climate conditions..." disabled={isSaving} />
                    </div>
                    <div className={styles.formGroup}>
                      <label htmlFor="terroir">Terroir</label>
                      <input type="text" id="terroir" value={terroir} onChange={(e) => setTerroir(e.target.value)} className={styles.input} placeholder="Soil composition, terrain..." disabled={isSaving} />
                    </div>
                  </div>
                  <div className={styles.formRow}>
                    <div className={styles.formGroup}>
                      <label htmlFor="viticulture">Viticulture</label>
                      <input type="text" id="viticulture" value={viticulture} onChange={(e) => setViticulture(e.target.value)} className={styles.input} placeholder="Vineyard practices..." disabled={isSaving} />
                    </div>
                    <div className={styles.formGroup}>
                      <label htmlFor="yields">Yields</label>
                      <input type="text" id="yields" value={yields} onChange={(e) => setYields(e.target.value)} className={styles.input} placeholder="Yield information..." disabled={isSaving} />
                    </div>
                  </div>
                </section>
