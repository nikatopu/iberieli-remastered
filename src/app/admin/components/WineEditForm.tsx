...
export default function WineEditForm({
  ...
  const [processing, setProcessing] = useState(
    wine.vinification?.processing || "",
  );
  const [fermentation, setFermentation] = useState(
    wine.vinification?.fermentation || "",
  );
  ...
  const [maceration, setMaceration] = useState(
    wine.vinification?.maceration || "",
  );
  const [macerationVessel, setMacerationVessel] = useState(
    wine.vinification?.macerationVessel || "",
  );
            ...
            <div className={styles.formRow}>
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  className={styles.input}
                  placeholder="Fermentation process..."
                  disabled={isSaving}
                />
              </div>
              <div className={styles.formGroup}>
            ...
            <div className={styles.formRow}>
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  value={fermentationVessel}
                  onChange={(e) => setFermentationVessel(e.target.value)}
                  className={styles.input}
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  id="maceration"
                  value={maceration}
                  onChange={(e) => setMaceration(e.target.value)}
                  className={styles.input}
                  placeholder="Maceration details..."
                  disabled={isSaving}
                />
              </div>
            </div>
            <div className={styles.formRow}>
              <div className={styles.formGroup}>
                ...
                <input
                  type="text"
                  id="macerationVessel"
                  value={macerationVessel}
                  onChange={(e) => setMacerationVessel(e.target.value)}
                  className={styles.input}
                  placeholder="Vessel type..."
                  disabled={isSaving}
                />
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  type="text"
                  id="maturationTime"
                  value={maturationTime}
                  onChange={(e) => setMaturationTime(e.target.value)}
                  className={styles.input}
                  placeholder="Aging duration..."
                  disabled={isSaving}
                />
              </div>
            </div>
            <div className={styles.formRow}>
              <div className={styles.formGroup}>
                ...
                <input
                  type="text"
                  id="maturationVessel"
                  value={maturationVessel}
                  onChange={(e) => setMaturationVessel(e.target.value)}
                  className={styles.input}
                  placeholder="Vessel type..."
                  disabled={isSaving}
                />
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  className={styles.input}
                  placeholder="Filtration process..."
                  disabled={isSaving}
                />
              </div>
            </div>
            <div className={styles.formRow}>
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  id="fining"
                  value={fining}
                  onChange={(e) => setFining(e.target.value)}
                  className={styles.input}
